-- Cadastro nao libera mais acesso antes do pagamento.
-- A conta nasce como pending e so vira active no webhook do Stripe.
...
DROP FUNCTION IF EXISTS public.create_saas_account(uuid, text, text, text, text);
